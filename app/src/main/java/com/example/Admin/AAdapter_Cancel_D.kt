...
class AAdapter_Cancel_D(val context: Context, val doctorList: ArrayList<DUserData>) :
    RecyclerView.Adapter<AAdapter_Cancel_D.doctorViewHolder>() {
    ...
    override fun onBindViewHolder(holder: doctorViewHolder, position: Int) {
        ...
        holder.dStatus.setOnClickListener {
            ...
            databaseRef.child("Cancel Doctor").child(dphone!!).removeValue()

            Toast.makeText(context,"$dphone",Toast.LENGTH_SHORT).show()



            //storage delete image
            val storageRef=FirebaseStorage.getInstance().getReference("Doctor")
            storageRef.child("Add Doctor").child(dphone).child("image").delete().addOnSuccessListener {

                Toast.makeText(context,"Delete Completely",Toast.LENGTH_SHORT).show()

            }.addOnFailureListener {

                Toast.makeText(context,"Delete Not Completely",Toast.LENGTH_SHORT).show()
        ...
        holder.dStatus.setOnLongClickListener{
            ...
            databaseReference.child("Add Doctor").child(dPhone!!).setValue(DUserData(dImg.toString(),
                dName.toString(),
                dEmail.toString(),
                dPhone,
                dGender.toString(),
                ...
                if(it.isSuccessful)
                {
                    ...
                    databaseReference.child("Dept Doctors").child(dDepartment.toString()).child(dPhone).setValue(DUserData(dImg.toString(),
                        dName.toString(),
                        dEmail.toString(),
                        dPhone,
                        dGender.toString(),
