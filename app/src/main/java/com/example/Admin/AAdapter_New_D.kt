...
class AAdapter_New_D(val context: Context, val doctorList: ArrayList<DUserData>) :
    RecyclerView.Adapter<AAdapter_New_D.doctorViewHolder>() {
                        ...
                        if(it.isSuccessful)
                        {
                            ...
                            databaseReference.child("Dept Doctors").child(dDepartment.toString()).child(dPhone).setValue(DUserData(dImg.toString(),
                                ...
                                if (it.isSuccessful) {
                                    ...
                                    databaseRef.child("New Doctor").child(dPhone).removeValue()
